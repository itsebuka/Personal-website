...
export default function Navbar() {
  ...
  return (
    <header className="h-14 shrink-0 bg-[#0a0a0a] border-b border-[#1a1a1a] flex items-center relative z-50">
          ...
          {navItems.map((item) => {
            ...
            return (
              <Link
                key={item.href}
                href={item.href}
                className={`relative px-3 py-1.5 text-xs font-medium tracking-wide uppercase transition-colors duration-200 rounded ${
