    ...
    >
      ...
      <div className="flex flex-col items-center justify-center flex-1 z-10 my-auto">
        ...
        <div className="flex items-center gap-3 mb-6 sm:mb-0">
          ...
          <MagneticButton>
            <a href="https://www.instagram.com/jocieferr/" target="_blank" rel="noopener noreferrer" aria-label="Instagram Profile" className="p-2 rounded border border-[#222] text-zinc-600 hover:text-white hover:border-[#444] transition-all duration-200 block">
